...
class RagAdminService:
    def __init__(
        ...
        *,
        ...
        knowledge_base: KnowledgeBaseInspectorPort | None = None,
        chunk_reader: ChunkReaderPort | None = None,
    ) -> None:
    ...
    def read_chunks_sync(
        ...
        *,
        ...
        raise RuntimeError(
            "事件循环已运行，请使用 await RagAdminService.read_chunks(...)。"
        )
