    ...
    return KnowledgeRuntimeConfig(
        ...
        rag=RagTuningConfig(
            ...
            cuda_reranker_batch_size=_env(
                "RAG_CUDA_RERANKER_BATCH_SIZE", 32
            ),
        ),
        ...
        docling=DoclingRuntimeConfig(
            ...
            image_bytes_per_page=_env(
                "DOCLING_AUTO_IMAGE_BYTES_PER_PAGE", 307_200
            ),
        ...
        models=ModelRuntimeConfig(
            ...
            reranker_threshold=_env("RERANKER_THRESHOLD", 0.1),
            reranker_debug=_env("RERANKER_DEBUG", False),
        ),
    )
