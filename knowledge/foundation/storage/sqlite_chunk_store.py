...
from knowledge.contracts import ChunkMetadata, KnowledgeDocument, StoredChunk
...
class SQLiteChunkStoreAdapter:
    ...
    @staticmethod
    def _row(document: KnowledgeDocument, fallback_id: str) -> tuple[object, ...]:
